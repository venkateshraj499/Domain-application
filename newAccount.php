...
<body>
    <div class="container">
        ...
        <form class="formWrapper" method="POST" action="dbnewaccount.php">
        <h3>CREATE AN ACCOUNT</h3>
            <label class="label">FULLNAME</label>
            <input id="name" type="text" name="fullname" class="text" /><br>
            ...
            <input id="dob" type="date" name="dob" class="date"></input><br>
